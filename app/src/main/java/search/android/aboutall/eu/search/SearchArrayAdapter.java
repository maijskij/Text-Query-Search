...
class SearchArrayAdapter extends RecyclerView.Adapter<SearchArrayAdapter.ViewHolder> {
    ...
    SearchArrayAdapter(List<String> data) {
        mDataset = data;
    }
    ...
    void addAll(List<String> data, String prefix) {
        mPrefix = prefix;
